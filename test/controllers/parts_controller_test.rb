...
class PartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create part" do
    assert_difference('Part.count') do
      post parts_url, params: { part: { link: @part.link, name: @part.name, setup_id: @part.setup_id } }
    end
  ...
  test "should update part" do
    patch part_url(@part), params: { part: { link: @part.link, name: @part.name, setup_id: @part.setup_id } }
