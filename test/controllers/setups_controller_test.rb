...
class SetupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create setup" do
    assert_difference('Setup.count') do
      post setups_url, params: { setup: { description: @setup.description, hero_image_id: @setup.hero_image_id, name: @setup.name } }
    end
  ...
  test "should update setup" do
    patch setup_url(@setup), params: { setup: { description: @setup.description, hero_image_id: @setup.hero_image_id, name: @setup.name } }
